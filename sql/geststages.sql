...
INSERT INTO `entreprise` (`num_entreprise`, `raison_sociale`, `nom_contact`, `nom_resp`, `rue_entreprise`, `cp_entreprise`, `ville_entreprise`, `tel_entreprise`, `fax_entreprise`, `email_entreprise`, `observation`, `site_entreprise`, `niveau`, `en_activite`) VALUES
(1, 'Webzine Maker (Campusplex)', 'Antoine Dupont', 'Antoine Dupont', '12 Rue Général Fiorella', 20000, 'Ajaccio', '01 02 03 04 05', '01 02 03 04 05', 'contact@infos.fr', null, 'http://www.wmaker.net/', 'BAC+1/BAC+2', 1),
...
INSERT INTO `etudiant` (`num_etudiant`, `nom_etudiant`, `prenom_etudiant`, `annee_obtention`, `login_etudiant`, `mdp_etudiant`, `num_classe`, `en_activite`) VALUES
...
INSERT INTO `professeur` (`num_prof`, `nom_prof`, `prenom_prof`, `login_prof`, `mdp_prof`, `email_prof`) VALUES
